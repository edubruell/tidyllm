...
---
> ⚠️ **Note:**  This vignette refers to the development version 0.2.7. of **tidyllm**, which haa major interface differences compared to the last release. If you are using the CRAN-version 0.2.0 please refer to the installed vignette by using `vignette("tidyllm")`. Version 0.2.7. is fully backward compatible to the old interface, but will throw deprecation warnings for some use cases.
