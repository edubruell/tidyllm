...
Image formats for `gemini_upload_file()` include **PNG**, **JPEG**, **WEBP**, **HEIC**, and **HEIF**, while supported video formats cover **MP4**, **MPEG**, **MOV**, **AVI**, **FLV**, **MPG**, **WEBM**, **WMV**, and **3GPP**. For audio, the API works with **WAV**, **MP3**, **AIFF**, **AAC**, **OGG Vorbis**, and **FLAC**.  Code files such as **JavaScript** and **Python** are also supported. 
