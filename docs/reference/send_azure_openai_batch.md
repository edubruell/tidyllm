...
This function creates and submits a batch of messages to the Azure
OpenAI Batch API for asynchronous processing.
...
- .id_prefix:
  ...
  names in `.llms` are missing (default: "tidyllm_azure_openai_req\_").
