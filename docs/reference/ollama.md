...
- For [`chat()`](https://edubruell.github.io/tidyllm/reference/chat.md):
  An updated `LLMMessage` object containing the model's response.

- For
  [`embed()`](https://edubruell.github.io/tidyllm/reference/embed.md): A
  matrix where each column corresponds to an embedding.
