...
|----|----|
| [`openai()`](https://edubruell.github.io/tidyllm/reference/openai.md) | Top benchmark performance across coding, math, and reasoning; `o3`/`o4` reasoning models |
...
| [`gemini()`](https://edubruell.github.io/tidyllm/reference/gemini.md) | 1M-token context window; video and audio via file upload API; search grounding; `.thinking_budget` for reasoning; batch |
| [`mistral()`](https://edubruell.github.io/tidyllm/reference/mistral.md) | EU-hosted, GDPR-friendly; Magistral reasoning models; embeddings; batch |
...
| [`openrouter()`](https://edubruell.github.io/tidyllm/reference/openrouter.md) | 500+ models via one API key; automatic fallback routing; [`openrouter_credits()`](https://edubruell.github.io/tidyllm/reference/openrouter_credits.md) and per-generation cost tracking |
