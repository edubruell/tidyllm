...
[`check_batch()`](https://edubruell.github.io/tidyllm/dev/reference/check_batch.md)/[`fetch_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_batch.md)
for batch objects, or to
[`perplexity_check_research()`](https://edubruell.github.io/tidyllm/dev/reference/perplexity_check_research.md)/[`perplexity_fetch_research()`](https://edubruell.github.io/tidyllm/dev/reference/perplexity_fetch_research.md)
for research jobs.
...
and [`img()`](https://edubruell.github.io/tidyllm/dev/reference/img.md)
...
- **New schema field functions inspired by ellmer and more schema
  ...
  functions[`field_chr()`](https://edubruell.github.io/tidyllm/dev/reference/field_chr.md),
...
[`chat()`](https://edubruell.github.io/tidyllm/dev/reference/chat.md) or
[`send_batch()`](https://edubruell.github.io/tidyllm/dev/reference/send_batch.md).Moreover,
...
- Google Gemini is the second API to fully support
  [`tidyllm_schema()`](https://edubruell.github.io/tidyllm/dev/reference/tidyllm_schema.md)
- [`gemini()`](https://edubruell.github.io/tidyllm/dev/reference/gemini.md)-requests
...
- Redesigned Reply Functions:
  ...
  `.json`-arguement.
- Deprecation of
  [`chatgpt()`](https://edubruell.github.io/tidyllm/dev/reference/chatgpt.md):
  The
  [`chatgpt()`](https://edubruell.github.io/tidyllm/dev/reference/chatgpt.md)
