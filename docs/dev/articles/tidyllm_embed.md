...
Use [`img()`](https://edubruell.github.io/tidyllm/dev/reference/img.md)
to create image objects and mix them with text in a list. When passing
such a list to `embed(voyage())`, the function automatically routes to
