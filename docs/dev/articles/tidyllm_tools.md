...
You only define the function and its parameter schema.
...
|----|----|----|
| [`field_chr()`](https://edubruell.github.io/tidyllm/dev/reference/field_chr.md) | string | text, identifiers, timezone names |
| [`field_dbl()`](https://edubruell.github.io/tidyllm/dev/reference/field_chr.md) | number | numeric values, prices, quantities |
| [`field_lgl()`](https://edubruell.github.io/tidyllm/dev/reference/field_chr.md) | boolean | flags, yes/no switches |
| [`field_fct()`](https://edubruell.github.io/tidyllm/dev/reference/field_chr.md) | string with enum | parameters with a fixed set of valid values |
