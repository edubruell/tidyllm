...
- [`df_llm_message()`](https://edubruell.github.io/tidyllm/dev/reference/df_llm_message.md)
  : Convert a Data Frame to an LLMMessage Object
- [`get_reply()`](https://edubruell.github.io/tidyllm/dev/reference/get_reply.md)
  [`last_reply()`](https://edubruell.github.io/tidyllm/dev/reference/get_reply.md)
  : Retrieve Assistant Reply as Text
- [`get_reply_data()`](https://edubruell.github.io/tidyllm/dev/reference/get_reply_data.md)
  [`last_reply_data()`](https://edubruell.github.io/tidyllm/dev/reference/get_reply_data.md)
  : Retrieve Assistant Reply as Structured Data
- [`get_user_message()`](https://edubruell.github.io/tidyllm/dev/reference/get_user_message.md)
  [`last_user_message()`](https://edubruell.github.io/tidyllm/dev/reference/get_user_message.md)
  : Retrieve a User Message by Index
- [`get_metadata()`](https://edubruell.github.io/tidyllm/dev/reference/get_metadata.md)
  [`last_metadata()`](https://edubruell.github.io/tidyllm/dev/reference/get_metadata.md)
...
- [`rate_limit_info()`](https://edubruell.github.io/tidyllm/dev/reference/rate_limit_info.md)
...
- [`fetch_openai_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_openai_batch.md)
  : Fetch Results for an OpenAI Batch
- [`list_openai_batches()`](https://edubruell.github.io/tidyllm/dev/reference/list_openai_batches.md)
  : List OpenAI Batch Requests
- [`cancel_openai_batch()`](https://edubruell.github.io/tidyllm/dev/reference/cancel_openai_batch.md)
...
- [`claude_list_models()`](https://edubruell.github.io/tidyllm/dev/reference/claude_list_models.md)
...
- [`check_claude_batch()`](https://edubruell.github.io/tidyllm/dev/reference/check_claude_batch.md)
  : Check Batch Processing Status for Claude API
- [`fetch_claude_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_claude_batch.md)
  : Fetch Results for a Claude Batch
- [`list_claude_batches()`](https://edubruell.github.io/tidyllm/dev/reference/list_claude_batches.md)
...
- [`gemini_list_models()`](https://edubruell.github.io/tidyllm/dev/reference/gemini_list_models.md)
...
- [`check_gemini_batch()`](https://edubruell.github.io/tidyllm/dev/reference/check_gemini_batch.md)
  : Check the Status of a Gemini Batch Operation
- [`fetch_gemini_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_gemini_batch.md)
  : Fetch Results for a Gemini Batch
- [`list_gemini_batches()`](https://edubruell.github.io/tidyllm/dev/reference/list_gemini_batches.md)
...
- [`groq_chat()`](https://edubruell.github.io/tidyllm/dev/reference/groq_chat.md)
...
- [`groq_list_models()`](https://edubruell.github.io/tidyllm/dev/reference/groq_list_models.md)
  : List Available Models from the Groq API
- [`send_groq_batch()`](https://edubruell.github.io/tidyllm/dev/reference/send_groq_batch.md)
  : Send a Batch of Messages to the Groq API
- [`check_groq_batch()`](https://edubruell.github.io/tidyllm/dev/reference/check_groq_batch.md)
  : Check Batch Processing Status for Groq API
- [`fetch_groq_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_groq_batch.md)
  : Fetch Results for a Groq Batch
- [`list_groq_batches()`](https://edubruell.github.io/tidyllm/dev/reference/list_groq_batches.md)
...
- [`mistral_chat()`](https://edubruell.github.io/tidyllm/dev/reference/mistral_chat.md)
  : Send LLMMessage to Mistral API
- [`mistral_embedding()`](https://edubruell.github.io/tidyllm/dev/reference/mistral_embedding.md)
  : Generate Embeddings Using Mistral API
- [`mistral_list_models()`](https://edubruell.github.io/tidyllm/dev/reference/mistral_list_models.md)
...
- [`check_mistral_batch()`](https://edubruell.github.io/tidyllm/dev/reference/check_mistral_batch.md)
  : Check Batch Processing Status for Mistral Batch API
- [`fetch_mistral_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_mistral_batch.md)
  : Fetch Results for an Mistral Batch
- [`list_mistral_batches()`](https://edubruell.github.io/tidyllm/dev/reference/list_mistral_batches.md)
...
- [`ollama_embedding()`](https://edubruell.github.io/tidyllm/dev/reference/ollama_embedding.md)
...
- [`perplexity_deep_research()`](https://edubruell.github.io/tidyllm/dev/reference/perplexity_deep_research.md)
  : Submit a Deep Research Request to Perplexity
- [`perplexity_check_research()`](https://edubruell.github.io/tidyllm/dev/reference/perplexity_check_research.md)
...
- [`openrouter_chat()`](https://edubruell.github.io/tidyllm/dev/reference/openrouter_chat.md)
  : Send LLM Messages to the OpenRouter Chat API
- [`openrouter_embedding()`](https://edubruell.github.io/tidyllm/dev/reference/openrouter_embedding.md)
  : Generate Embeddings Using the OpenRouter API
- [`openrouter_list_models()`](https://edubruell.github.io/tidyllm/dev/reference/openrouter_list_models.md)
  : List Available Models on OpenRouter
- [`openrouter_credits()`](https://edubruell.github.io/tidyllm/dev/reference/openrouter_credits.md)
  : Get OpenRouter Credit Balance
- [`openrouter_generation()`](https://edubruell.github.io/tidyllm/dev/reference/openrouter_generation.md)
...
- [`llamacpp_embedding()`](https://edubruell.github.io/tidyllm/dev/reference/llamacpp_embedding.md)
  : Generate Embeddings Using a llama.cpp Server
- [`llamacpp_rerank()`](https://edubruell.github.io/tidyllm/dev/reference/llamacpp_rerank.md)
  : Rerank Documents Using a llama.cpp Server
- [`llamacpp_list_models()`](https://edubruell.github.io/tidyllm/dev/reference/llamacpp_list_models.md)
...
- [`llamacpp_list_local_models()`](https://edubruell.github.io/tidyllm/dev/reference/llamacpp_list_local_models.md)
...
- [`llamacpp_delete_model()`](https://edubruell.github.io/tidyllm/dev/reference/llamacpp_delete_model.md)
...
- [`azure_openai_chat()`](https://edubruell.github.io/tidyllm/dev/reference/azure_openai_chat.md)
  : Send LLM Messages to an Azure OpenAI Chat Completions endpoint
- [`azure_openai_embedding()`](https://edubruell.github.io/tidyllm/dev/reference/azure_openai_embedding.md)
  : Generate Embeddings Using OpenAI API on Azure
- [`send_azure_openai_batch()`](https://edubruell.github.io/tidyllm/dev/reference/send_azure_openai_batch.md)
  : Send a Batch of Messages to Azure OpenAI Batch API
- [`check_azure_openai_batch()`](https://edubruell.github.io/tidyllm/dev/reference/check_azure_openai_batch.md)
  : Check Batch Processing Status for Azure OpenAI Batch API
- [`fetch_azure_openai_batch()`](https://edubruell.github.io/tidyllm/dev/reference/fetch_azure_openai_batch.md)
  : Fetch Results for an Azure OpenAI Batch
- [`list_azure_openai_batches()`](https://edubruell.github.io/tidyllm/dev/reference/list_azure_openai_batches.md)
...
- [`LLMMessage()`](https://edubruell.github.io/tidyllm/dev/reference/LLMMessage.md)
