...
[`chat()`](https://edubruell.github.io/tidyllm/reference/chat.md) when
...
- [`chat_completions()`](https://edubruell.github.io/tidyllm/reference/chat_completions_chat.md)
  ...
  [`chat()`](https://edubruell.github.io/tidyllm/reference/chat.md) with
  any common argument at all; `chat(..., .dry_run = TRUE)` and every
  other shared argument raised “not supported by the provider’s
